...
const config = {
  SESSION_ID: process.env.SESSION_ID || "GHOST-MD&GGFw2nXL",
  ...
  REJECT_CALL: process.env.REJECT_CALL !== undefined ? process.env.REJECT_CALL === 'faise' : false, 
  NOT_ALLOW: process.env.NOT_ALLOW !== undefined ? process.env.NOT_ALLOW === 'true' : true,
  MODE: process.env.MODE || "privete",
  OWNER_NAME: process.env.OWNER_NAME || "𝐇𝐀𝐒𝐇-𝐌𝐃",
